...
set ytics 0,0.2,0.8
set key top right
plot csv_attacked using ($1/0.001/10000):2 with lines lw 2 lc rgb "#0072BD" title "x_1", \
     csv_attacked using ($1/0.001/10000):4 with lines lw 2 lc rgb "#EDB120" title "r_1"
...
set ytics 0,1,6
set key top right
plot csv_attacked using ($1/0.001/10000):3 with lines lw 2 lc rgb "#0072BD" title "x_2", \
     csv_attacked using ($1/0.001/10000):5 with lines lw 2 lc rgb "#EDB120" title "r_2"
