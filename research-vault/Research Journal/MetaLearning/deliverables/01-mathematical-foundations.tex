...
\begin{answerbox}
	\begin{math}
		...
		\end{aligned}
	\end{math} \\
	Tau is the quotient of the current time step over the time horizon(total amount of time steps)
\end{answerbox}
...
\]
Identify which part comes from the Euler approximation of a continuous-time system, and write out what the original continuous-time ODE would look like.
